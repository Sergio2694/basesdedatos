...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-05-2019 a las 22:46:53
...
(1, 'Sergio gamboa martinez', '87548947', 'sergdios09@gmail.com', 'dsds', 1, '2019-04-06 20:12:57');
...
CREATE TABLE `empaque` (
  ...
  `emp_encargado` varchar(200) COLLATE latin1_spanish_ci NOT NULL,
  `emp_fecha` datetime NOT NULL,
  `num_factura` varchar(200) COLLATE latin1_spanish_ci NOT NULL
...
INSERT INTO `empaque` (`emp_code`, `emp_encargado`, `emp_fecha`, `num_factura`) VALUES
(1, 'Sergio gamboa martinez', '2019-04-28 01:56:44', '3'),
(2, 'Sergio gamboa martinez', '2019-04-28 02:56:21', '15'),
(3, 'Sergio gamboa martinez', '2019-04-28 02:58:21', '14'),
(4, 'Sergio gamboa martinez', '2019-04-28 15:44:49', '19');
...
(19, 1, '2019-04-28 15:44:24', 1, 1, '1', '162.72', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `horneo`
--

CREATE TABLE `horneo` (
  `hor_code` int(11) NOT NULL,
  `hor_nombre` varchar(200) COLLATE latin1_spanish_ci NOT NULL,
  `hor_fecha` datetime NOT NULL,
  `num_factura` varchar(200) COLLATE latin1_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

--
-- Volcado de datos para la tabla `horneo`
--

INSERT INTO `horneo` (`hor_code`, `hor_nombre`, `hor_fecha`, `num_factura`) VALUES
(1, 'ks', '0000-00-00 00:00:00', '5'),
(2, ',xmcmx', '0000-00-00 00:00:00', '5'),
(3, 'Sergio', '2019-04-28 01:11:57', '5'),
(4, '', '2019-04-28 01:22:53', '3'),
(5, 'Sergio gamboa martinez', '2019-04-28 01:25:20', '3'),
(6, 'Sergio gamboa martinez', '2019-04-28 02:56:21', '15'),
(7, 'Sergio gamboa martinez', '2019-04-28 02:56:21', '15'),
(8, 'Sergio gamboa martinez', '2019-04-28 02:58:21', '14'),
(9, 'Sergio gamboa martinez', '2019-04-28 15:44:49', '19');
...
CREATE TABLE `produccion` (
  ...
  `prod_encargado` varchar(100) COLLATE latin1_spanish_ci NOT NULL,
  `prod_fecha_hora` datetime NOT NULL,
  `num_factura` varchar(200) COLLATE latin1_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
INSERT INTO `produccion` (`prod_code`, `prod_encargado`, `prod_fecha_hora`, `num_factura`) VALUES
(1, 'Sergio gamboa martinez', '2019-04-28 01:49:19', '3'),
(2, 'Sergio gamboa martinez', '2019-04-28 02:56:21', '15'),
(3, 'Sergio gamboa martinez', '2019-04-28 02:58:21', '14'),
(4, 'Sergio gamboa martinez', '2019-04-28 11:56:01', '17'),
(5, 'Sergio gamboa martinez', '2019-04-28 11:56:01', '17'),
(6, 'Sergio gamboa martinez', '2019-04-28 11:56:01', '17'),
(7, 'Sergio gamboa martinez', '2019-04-28 15:44:49', '19');
...
(1, 'de', 'Empanada de PiÃ±a', 1, '2019-04-06 20:13:20', 12);
...
--
-- Indices de la tabla `horneo`
--
ALTER TABLE `horneo`
  ADD PRIMARY KEY (`hor_code`);
...
--
-- AUTO_INCREMENT de la tabla `horneo`
--
ALTER TABLE `horneo`
  MODIFY `hor_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `produccion`
  MODIFY `prod_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tmp`
  MODIFY `id_tmp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
