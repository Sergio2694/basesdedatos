...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-05-2019 a las 22:45:11
...
(1, 'Sergio Gamboa Martinez', '87548947', 'sergdios09@gmail.com', 'Tuis Turrialba Cartago', 1, '2019-01-14 17:51:35');
...
(2, 1, '2019-01-13 00:00:00', 1, 1, '1', '102000', 1),
(3, 2, '2019-01-16 00:00:00', 1, 1, '1', '10000', 1),
(4, 3, '2019-02-03 00:00:00', 1, 1, '1', '11200', 1),
(5, 4, '2019-02-11 00:00:00', 1, 1, '1', '1200', 1);
...
CREATE TABLE `inventario` (
  ...
  `kg_Oro` varchar(100) NOT NULL,
  `kg_Tostado` varchar(50) NOT NULL,
  `rend` varchar(50) NOT NULL,
...
INSERT INTO `inventario` (`id_Inventario`, `fecha_De_Compra`, `proveedor`, `kg_Oro`, `kg_Tostado`, `rend`, `tiempo`, `observacion`, `id_Finca`) VALUES
(3, '2019-02-04', 'San Valentin', '12', '12', '11', '12', 'se realizo ...', 3),
(4, '2019-02-04', 'sa', '2', '4', '3', '1', 'se realizo ...', 3);
...
CREATE TABLE `perfil` (
  ...
  `moneda` varchar(255) CHARACTER SET utf8 NOT NULL,
...
(1, 'CafÃ© MisiÃ³n De Costa Rica S.A.', 'Tuis Barrio 70', 'Turrialba', '3301', 'Cartago', '+(506 ) 7114 1914', '3-101-681472', 0, 'C', 'img/1547486592_logo.jpg');
...
(2, '1', 'Cajuela', 1, '2019-01-14 19:15:39', 1200),
(3, '2', 'Saco de CafÃ©', 1, '2019-01-14 19:15:59', 10000);
...
(1, 'Daniel ', 'Montoya', 'admin', '$2y$10$MPVHzZ2ZPOWmtUUGCq3RXu31OTB.jo7M9LZ7PmPQYmgETSNn19ejO', 'admin@admin.com', '2016-05-21 15:06:00');
